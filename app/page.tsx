    ...
    <>
      ...
      <section className="pt-20 pb-24">
        ...
        <p className="text-xl text-secondary leading-relaxed max-w-2xl mb-10">
          I am a computer science student building full-stack applications and
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            {skills.map((skill) => (
              <span
                key={skill}
                className="bg-white border border-accent text-text text-sm font-medium px-5 py-2 rounded-full shadow-sm"
              >
                {skill}
              </span>
            ))}
